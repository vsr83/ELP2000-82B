...
// The values have been corrected according to Table 4 in:
...
/**
 * Compute spherical coordinates of the Moon with ELP2000-82b in the inertial 
 * mean ecliptic of date geocentric frame.
 *   
 * @param {*} JT 
 *      Julian time (TDB).
 * 
 * @returns Object with longitude, latitude and distance, where the distance is
 * in kilometers and angles are in radians.
 */
export function elp2000SphericalOfDate(JT)
{
    // Julian centuries after epoch.
...
/**
 * Compute cartesian coordinates of the Moon with ELP2000-82b in the inertial 
 * mean ecliptic of date geocentric frame.
 * 
 * @param {*} JT 
 *      Julian time (TDB).
 ...
 */
export function elp2000CartesianOfDate(JT)
{
    const {longitude, latitude, distance} = elp2000SphericalOfDate(JT);
...
/**
 * Compute cartesian coordinates of the Moon with ELP2000-82b in the inertial 
 * mean ecliptic of J2000 date geocentric frame.
 * 
 * @param {*} JT 
 *      Julian time (TDB).
 * @returns Position in meters.
 */
export function elp2000CartesianJ2000(JT)
{
    let xMod, yMod, zMod;
    [xMod, yMod, zMod] = elp2000CartesianOfDate(JT);
